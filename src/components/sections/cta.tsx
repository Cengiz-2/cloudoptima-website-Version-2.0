      ...
      <div className="mx-auto max-w-5xl px-6">
        <Reveal>
          <div className="noise relative overflow-hidden rounded-3xl border border-line bg-surface/60 px-6 py-16 text-center md:px-16 md:py-20">
            <div aria-hidden className="grid-bg absolute inset-0 [mask-image:radial-gradient(ellipse_60%_70%_at_50%_40%,black,transparent)]" />
            <motion.div
              aria-hidden
            ...
            <div className="relative z-10">
              ...
              <p className="mx-auto mt-5 max-w-xl text-lg text-ink-soft">
                Der Control-Check ist ein kurzer Fragebogen zu MFA, Offboarding,
                Datenfreigaben und Geräte-Patching. Sie bekommen eine ehrliche
                Einschätzung innerhalb von 48 Stunden, keine Verkaufsshow.
              </p>
              <div className="mt-10">
                <ParticleButton href={`mailto:${site.email}?subject=${encodeURIComponent("Control-Check anfragen")}`}>
                  Control-Check anfragen
